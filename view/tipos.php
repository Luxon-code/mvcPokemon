...
<head>
    ...
    <title id="tituloBarra">Tipos Pokemon</title>
</head>
<body onload="PrintPokemon(),typePokemon2(),searchPokemon(),listarCarrito()" class="fondo">
    <div class="container-fluid">
        ...
        <div class="row my-5">
            <div class="col-12">
                <h1 class="text-center text-uppercase fontPokemon" id="titulo"></h1>
            </div>
        </div>
    ...
    <button class="btn btn-outline-warning"  data-bs-toggle="modal" data-bs-target="#staticBackdrop">Hacer Pedido</button>
</div>
